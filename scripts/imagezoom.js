/*function zoomIn(event) {
    ...
    element.style.backgroundPosition = (-posX * 2) + "px " + (-posY * 2.9) + "px";
...
function cambiarImg() {
    let image = document.querySelectorAll('.item-image');
    image.forEach(function (item, idx) {
...
/*(function () {
    ...
    for (let i = 0; i < galleryImg.length; i++) {
        galleryImg[i].mousemove = function () {
